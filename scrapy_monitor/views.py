...
def day_monitor(request):
    ...
    for i in range(0,30):
        ...
        News_count = xinlang_new.objects.filter(post_time__contains=date_past).count()

        totalNum_list.append(Weibo_count+News_count)
        sinaWeiboNum_list.append(Weibo_count)
        sinaNewsNum_list.append(News_count)
        Earthquake_count = weibo_post.objects.filter(post_time__contains=date_past,task_id='1_1').count()+xinlang_new.objects.filter(post_time__contains=date_past,task_id='2_1').count()
        Typhoon_count = weibo_post.objects.filter(post_time__contains=date_past,task_id='1_2').count()+xinlang_new.objects.filter(post_time__contains=date_past,task_id='2_2').count()
        Rain_count = weibo_post.objects.filter(post_time__contains=date_past,task_id='1_3').count()+xinlang_new.objects.filter(post_time__contains=date_past,task_id='2_3').count()
...
def timed_monitor(request):
    ...
    for i in range(0,23):
        ...
        News_count = xinlang_new.objects.filter(post_time__contains=time_past).count()
        totalNum_list.append(Weibo_count + News_count)
        sinaWeiboNum_list.append(Weibo_count)
        sinaNewsNum_list.append(News_count)
        ...
        Earthquake_count = weibo_post.objects.filter(post_time__contains=time_past,task_id='1_1').count() + xinlang_new.objects.filter(post_time__contains=time_past,task_id='2_1').count()
        Typhoon_count = weibo_post.objects.filter(post_time__contains=time_past,task_id='1_2').count() + xinlang_new.objects.filter(post_time__contains=time_past,task_id='2_2').count()
        Rain_count = weibo_post.objects.filter(post_time__contains=time_past,task_id='1_3').count() + xinlang_new.objects.filter(post_time__contains=time_past,task_id='2_3').count()
        EarthquakeNum_list.append(Earthquake_count)
        TyphoonNum_list.append(Typhoon_count)
        RainNum_list.append(Rain_count)
